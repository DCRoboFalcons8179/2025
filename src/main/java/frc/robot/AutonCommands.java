...
public class AutonCommands {
    public static void GenCommands(Drive drive, ElevatorSub elevatorSub, CoralSub coralSub,
            CommandXboxController commandXboxController, TopCamera topCamera, FrontCamera frontCamera) {
        ...
        NamedCommands.registerCommand("HumanCoral",
                new MoveElevator(() -> 2300, elevatorSub)
                        .andThen(new MoveWrist(() -> 0, coralSub))
                        .andThen(new MoveCoral(() -> 1, coralSub)));
        NamedCommands.registerCommand("ScoreL4Left",
        ...
        NamedCommands.registerCommand("ScoreL4Right", new SequentialCommandGroup(
                ...
                new AlignToTag(drive, frontCamera, commandXboxController, Constants.SetPoints.L4.desiredXTagDistanceMeters, Constants.SetPoints.L4.rightDesiredYTagDistanceMeters),
        ...
        NamedCommands.registerCommand("AlignToHumanPickup",
